...
# def print_div(classes: List, content: str, dropdown: List[DropdownEntry]):
...
if __name__ == "__main__":
    # experiment_path = 'models/20201011-coreflinker-cp3-5/'
    # output_path = 'models/20201011-coreflinker-cp3-5/marked_htmls/'
    ...
    for curr_test_line in in_test_file:
        ...
        # sorted_fp_spans = sorted(fp_mention_spans, key=lambda x: x[0])
